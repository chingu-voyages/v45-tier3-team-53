                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <Dialog.Panel className="w-full max-w-xl rounded bg-white px-20">
                        <div className="flex flex-col items-center">
                            <Dialog.Title className="text-xl font-medium">Plan your next trip</Dialog.Title>
                            ...
                            <div className="flex items-center w-full my-2 justify-between">
                                <div className="mx-1">
                                    <div>From:</div>
                                    <div>
                                        <DatePicker className="border-black border rounded"
                                                    selected={fromDate} openToDate={new Date()} minDate={new Date()}
                                ...
                                <div className="mx-1">
                                    ...
                                    <div>
                                        <DatePicker className="border-black border rounded"
                                                    selected={toDate} minDate={fromDate}
                                                    onChange={(date: Date) => setToDate(date)}
                                                    placeholderText="Select your end date"/>
                                    </div>
                                </div>
                            </div>
                            <button className="rounded-md bg-black bg-opacity-10 px-4 py-2 my-5"
                                    onClick={handleSubmit}>Start planning
                            </button>
                        </div>
                    </Dialog.Panel>
                </div>
